...
public class Elevator {
	...
	public static void main(String[] args) {
		...
		int[] A ={60,80,40,40,30,80};
		int[] B ={3,2,2,1,4,5};
		CountStops(A,B,5,2,140);
	}
	...
	public static int CountStops(int[] A, int[] B, int M, int X, int Y){
		...
		int tripMemebers =0;
		int tripWeight =0;
		ArrayList<Integer> tripDistinctStops = new  ArrayList<Integer>();
		for(int i=0;i<A.length;i++){
			...
			}else{ //Exceeded trip size or weight and completed trip
